...
public class BookingSteps {
    ...
    public ValidatableResponse createBooking(String firstName, String lastName, String totalPrice, String depositPaid,
    ...
    public ValidatableResponse updateBooking(int bookingId, String firstName, String lastName, String totalPrice,
    ...
    @Step("Update partial booking with bookingId: {0}, firstName: {1}, lastName: {2}, totalPrice: {3}, depositPaid: {4}, " +
            "checkIn: {5}, checkOut: {6} and additionalNeeds: {7}")
    public ValidatableResponse updatePartialBooking(int bookingId, String firstName, String lastName, String totalPrice,
                                                    String depositPaid, String checkIn, String checkOut,
                                                    String additionalNeeds, String token) {
        BookingDates bookingDates = BookingDates.getBookingDates(checkIn, checkOut);
        BookingPojo requestBody = BookingPojo.getRequestBody(firstName, lastName, totalPrice, depositPaid, bookingDates,
